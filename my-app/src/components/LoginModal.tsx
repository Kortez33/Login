...
export const LoginModal = ({ open, onClose, onSwitchToRegister }: LoginModalProps) => {
    const {
        username, setUsername, password, setPassword, error, isLoading, handleLogin
    } = useLogin(onClose);
            ...
            <Paper sx={modalStyle} elevation={24}>
                ...
                <Box component="form" onSubmit={handleLogin}>
                    ...
                    <Button
                        ...
                        sx={{ mt: 3, mb: 2, height: '48px' }} disabled={isLoading}
                    >
                    ...
                    <Button
                        fullWidth variant="text" onClick={onSwitchToRegister} disabled={isLoading}
                    >
